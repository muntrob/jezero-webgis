...
//      const coordinate = pixel.getSource.coordinate;
      ...
      var h1_popup = document.createElement('H2');
      h1_popup.appendChild(document.createTextNode(feature.get('Name')));
      content.appendChild(h1_popup);
      //h1_popup.style.fontWeight = 'bold';
      h1_popup.style.fontWeight = '900';
      //h1_popup.style.fontSize = '15pt';
			h1_popup.style.paddingBottom = '20pt';
			h1_popup.style.paddingTop = '20pt';
      h1_popup.style.paddingLeft = '10pt';
      h1_popup.style.paddingRight = '10pt';
			h1_popup.style.backgroundColor='#DDD';
      h1_popup.setAttribute('align', 'center');
...
//      p_popup.appendChild(document.createTextNode(d.getMonth() + " " + d.getDay() + ", " + d.getFullYear()));
      ...
      popup_span.style.paddingRight = '10pt';
...
//      p_popup.appendChild(popup_date);
      ...
      popup_preview_img.style.paddingBottom = '5pt';
      content.appendChild(popup_preview_img);
      
      // Link to product(s) webpage
      var p_popup = document.createElement('p');
      p_popup.style.fontWeight = 'bold';
      
      var popup_a = document.createElement('a');
      popup_a.setAttribute('href', feature.get('URL_PR'));
      popup_a.appendChild(document.createTextNode('Click Here'));
      
      var popup_span = document.createElement('span');
      // popup_span.style.fontWeight = 'bold';
      popup_span.appendChild(popup_a);

      p_popup.appendChild(document.createTextNode('Product page: '));
      p_popup.appendChild(popup_span);
      // p_popup.appendChild(popup_a);
      // p_popup.appendChild(document.createTextNode('\t'));
      // p_popup.appendChild(document.createTextNode(feature.get('Titel')));
      content.appendChild(p_popup)
...
//      p_popup.appendChild(document.createTextNode(d.getMonth() + " " + d.getDay() + ", " + d.getFullYear()));
      var popup_span = document.createElement('span');
      //popup_span.style.fontWeight = 'bold';
      popup_span.appendChild(popup_description_long);
      p_popup.appendChild(popup_span);
      content.appendChild(p_popup);
